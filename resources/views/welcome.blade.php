                  ...
                  <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="mt-8">
                                <h4 class="text-center">WELLCOME TO MY PROJECT</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mt-4">
                                @auth
                                <a href="{{ url('/home') }}" class="fs-4 text-primary">Home</a>
                                @else
                                    <a href="{{ route('login') }}" class="fs-4 text-primary">Log in</a>
    
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="ml-2 text-end fs-4 text-primary">Register</a>
                                    @endif
                                @endauth
                            </div>
                        </div>
